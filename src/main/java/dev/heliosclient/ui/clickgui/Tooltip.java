    ...
    public void render(DrawContext drawContext, TextRenderer textRenderer, int mouseX, int mouseY)
    {
        if (!this.tooltipText.isEmpty()) {
            if (this.mode == 0) {
                ...
                drawContext.drawText(textRenderer, this.tooltipText, mouseX + 4, mouseY - 11, ColorManager.INSTANCE.defaultTextColor(), true);
            } else if (this.mode == 1) {
                ...
                drawContext.drawText(textRenderer, this.tooltipText, drawContext.getScaledWindowWidth()-textRenderer.getWidth(this.tooltipText)-2, drawContext.getScaledWindowHeight() -10, ColorManager.INSTANCE.defaultTextColor(), true);
            } else if (this.mode == 2) {
